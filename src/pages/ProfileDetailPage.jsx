      ...
      <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-4/5 mx-auto mb-5">
        ...
        <div className="flex flex-col md:flex-row justify-between mb-4">
          ...
          <div className="md:w-1/2">
            ...
            <div className="mb-6">
            <h1 className="text-lm font-semibold">Add your own answer below 😇</h1>
                  ...
                  {profile.customAnswers &&
                    Object.keys(profile.customAnswers).map((key) => (
                      <div key={key} className="mb-2">
                        <p className="text-sm text-gray-600">{profile.customAnswers[key].name}: {profile.customAnswers[key].answer}</p>
                      </div>
                    ))}
                </div>
